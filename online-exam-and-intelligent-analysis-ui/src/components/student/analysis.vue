<template>
    <el-container style="margin: 0 10px;">
      <el-header height="10px" style="margin: 10px 0px;text-align: left;padding: 5px 5px;">
        <el-row>
          ...
          <div v-for="(subject, index) in options" :key="index">
            <el-col :class="{ 'selected': selectedIndex === index}" style="padding: 7px 7px;margin:3px 8px;font-size: 13px;" @Click="selectSubject(subject.value,index)" >
              {{subject.label}}
            </el-col>
          </div>
        </el-row>
      ...
      <el-main style="margin-left: 5px;max-height: 100vh;-ms-overflow-style: none;  /* IE and Edge */
