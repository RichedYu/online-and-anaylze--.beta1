<template>
   ...
   <!--    新增弹窗-->
    <el-dialog v-model="dialogVisible" width="30%"  :title="title" :before-close="handleClose">
            ...
            <el-select v-model="form.position" placeholder="请选择职称" style="width:80%">
              <el-option label="教授" value="教授" @click="form.position='教授'"></el-option>
              <el-option label="副教授" value="副教授" @click="form.position='副教授'"></el-option>
              <el-option label="讲师" value="讲师" @click="form.position='讲师'"></el-option>
              <el-option label="助教" value="助教" @click="form.position='助教'"></el-option>
            </el-select>
            </el-form-item>
   ...
   <div class="info">
    <!--    显示表格-->
        <el-table :data="tableData" height="440" stripe style="width: 100%" >
            <el-table-column prop="eno" label="工号" sortable/>
            <el-table-column prop="name" label="姓名"/>
            <el-table-column prop="institution" label="所属学院"/>
            <el-table-column prop="position" label="职称"/>
            <el-table-column prop="classNum" label="管理班级数"/>
            <el-table-column prop="createTime" label="创建时间"/>
            <el-table-column prop="updateTime" label="更新时间"/>
            <el-table-column fixed="right" label="操作" width="120">
            <template #default="scope">
                <el-button type="text" @click="handleEdit(scope.row)">详情</el-button>
                <el-popconfirm title="确认删除吗?" @confirm="del(scope.row.eno)">
                <template #reference>
...
export default {
  ...
  methods: {
    list() {
      ...
      request.get(`/api/exam/teacherList/${current}/${size}/${keyword}`).then(res => {
