                            ...
                            <el-row>
                              <div v-for="(question, index) in item.answers" :key="index">
                                <el-col class="exam-item" :span="4">
                                    ...
                                    :class="{ 'selected': selectedIndex === index,'inputed': (score[question.questionId] ||score[question.questionId] === 0) &&selectedIndex !== index }"
                        ...
                        <div v-if="item.questionType === '2'">
                            ...
                            <el-row>
                              <div v-for="(question, index) in item.answers" :key="index">
                                <el-col class="exam-item" :span="4">
                                    <el-button type="default" circle="true" 
                                    :class="{ 'selected': selectedIndex === index+sumQuestionNum(num-1),'inputed': (score[question.questionId] ||score[question.questionId] === 0) &&selectedIndex !== index+sumQuestionNum(num-1)}"
                ...
                <div style="float: left;width: 90%;height: 450px;position: relative;">
                    <div v-if="question.type === '1'">
                        ...
                        <div>
                            ...
                            <!-- <div style="float: left;background-color: rgb(245, 242, 242);width: 100%;text-align: left;font-family: Inter, 'Helvetica Neue', Helvetica, 'PingFang SC',
                            'Hiragino Sans GB', 'Microsoft YaHei', '微软雅黑', Arial, sans-serif;">
                                <div style="margin: 10px;">正确答案：{{ referenceAnswer[question.questionId] }}</div>
                                <div style="margin: 10px;">结果：
                                    <div v-if="answerSheet.answers[question.questionId] === referenceAnswer[question.questionId]"><el-button type="success" style="">正确</el-button></div>
                                    <div v-else><el-button type="danger">错误</el-button></div>                                </div>
                    ...
                    <div v-if="question.type === '4'">
                        ...
                        <div v-for="n in question.answerCount" :key="n">
                            <div style="float: left; width: 100%;text-align: left;margin-left: 30px;color: rgb(93, 95, 95);">
                                ...
                                参考答案：{{ referenceAnswer[question.questionId][n-1] }}
                            </div>
                        </div>
                        <div style="float: left; width: 100%;text-align: left;margin-left: 30px;">
                            赋分(0~{{ question.score }})：<el-input-number
                            v-model="score[question.questionId]"
                            placeholder=""
                            :precision="1"
                            :step="0.5"
                            type="number"
                    ...
                    <div v-if="question.type === '5'">
                        ...
                        <div>
                            <div style="margin-left: 3px;margin-bottom: 10px;">参考答案：</div>
                            <div style="background-color: rgb(244, 249, 247);padding: 12px;width=100%;margin-bottom: 10px;">
                                {{ referenceAnswer[question.questionId] }}
                            </div>
                        </div>
                        <div style="float: left; width: 100%;text-align: left;margin-left: 30px;">
                            赋分(0~{{ question.score }})：<el-input-number
                    ...
                    <div v-if="question.type === '6'">
                        ...
                        <!-- 文本输入框 -->
                        <span style="margin-left: 10px;margin-bottom: 30px;height: 35px;width: 100%;">考生作答：</span>
